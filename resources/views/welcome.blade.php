            ...
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="w-full lg:w-3/5 relative">
                    ...
                    <div class="w-full lg:w-2/3 relative">
                        ...
                        <!-- Carousel Card Track -->
                        <div id="carousel-track" class="flex gap-6 overflow-x-auto snap-x scroll-smooth pb-4 pr-6 scrollbar-none" style="scrollbar-width: none;">
                            <!-- Card 1 -->
            ...
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                    ...
                    <div class="bg-bg-primary border border-border-card rounded-lg p-6 relative overflow-hidden group flex flex-col justify-between min-h-90 transition-all duration-300">
                        ...
                        <div class="relative mt-6 h-40 rounded-2xl border border-border-light bg-bg-secondary overflow-hidden p-4 select-none flex flex-col justify-end gap-3">
