...
$trips = computed(function () {
    ...
    if ($this->searchTrip) {
        $query->where(function ($q) {
            $q->where('name', 'ilike', '%' . $this->searchTrip . '%')
              ->orWhere('destination', 'ilike', '%' . $this->searchTrip . '%');
        });
    }
                                        ...
                                        <tr class="align-middle">
                                            <td class="py-4 pr-4">
                                                <div class="flex items-center space-x-3">
                                                    <div class="h-9 w-9 rounded-full bg-bg-secondary border border-border-light flex items-center justify-center font-bold text-xs uppercase text-text-main">
                                                        {{ $u->name[0] }}
                                                    </div>
                                                    <div>
